...
class TeraWurflConfig{
	 ...
	 * @var String
	 */
	public static $WURFL_CVS_URL = "http://downloads.sourceforge.net/project/wurfl/WURFL/2.3.1/wurfl-2.3.1.xml.gz?r=http%3A%2F%2Fsourceforge.net%2Fprojects%2Fwurfl%2Ffiles%2FWURFL%2F2.3.1%2F&ts=1333435114&use_mirror=internode";
	/**
	 * Data Directory
	 * @var String
	 */
	 ...
	 * @var String
	 */
	public static $LOG_FILE = '../../../Tmp/Log/wurfl.log';
	/**
