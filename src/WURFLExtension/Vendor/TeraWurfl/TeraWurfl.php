...
if(!class_exists('TeraWurflConfig',false))
	require_once __DIR__.'/TeraWurflConfig.php';
/**#@+
 * Include required files
 */
require_once __DIR__.'/DatabaseConnectors/TeraWurflDatabase.php';
require_once __DIR__.'/TeraWurflLoader.php';
require_once __DIR__.'/UserAgentFactory.php';
require_once __DIR__.'/UserAgentUtils.php';
require_once __DIR__.'/WurflConstants.php';
require_once __DIR__.'/WurflSupport.php';
require_once __DIR__.'/UserAgentMatchers/UserAgentMatcher.php';
/**#@-*/
/**
